...
redis:set(CZAR.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(CZAR..'lock:join:'..msg.chat_id_,true)
...
redis:del(CZAR..'lock:join:'..msg.chat_id_)
...
local GroupName = (redis:get(CZAR..'group:name'..msg.chat_id_) or '')
redis:set(CZAR..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(CZAR..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if MsgText[1] == "المنشئين الاساسين"  then  
...
if not msg.Director then return "✠*︙*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n✠" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. CZAR..'')
...
function(arg,data)
if data.ID == "Ok" then
redis:set(CZAR..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if redis:get(CZAR..'lock:kara:'..msg.chat_id_) == 'on' then
...
elseif redis:sismember(CZAR..':SUDO_BOT:',UserID) then 
rinkuser = 2
elseif redis:sismember(CZAR..':KARA_BOT:'..msg.chat_id_,UserID) then 
rinkuser = 3
elseif redis:sismember(CZAR..':MONSHA_BOT:'..msg.chat_id_,UserID) then 
rinkuser = 4
elseif redis:sismember(CZAR..'owners:'..msg.chat_id_,UserID) then 
...
if not msg.malk then return "✠*︙*هذا الامر يخص {المطور,المطور الاساسي} فقط  \n✠" end
if not MsgText[2] and msg.reply_id then 
...
if not msg.Director then return "✠*︙*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n✠" end
redis:setex(CZAR..'linkGroup'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "✠*︙*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n✠" end
redis:setex(CZAR..'rulse:witting'..msg.sender_user_id_,300,true)
...
redis:set(CZAR..'flood'..msg.chat_id_,MsgText[2]) 
...
if MsgText[2] == "المنشئيين الاساسين" then
if not msg.SudoUser then return "✠*︙*هذا الامر يخص {المطور} فقط  \n✠" end
local NumMnsha = redis:scard(CZAR..':KARA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "✠︙عذرا لا يوجد منشى اساسي \n!" 
end
redis:del(CZAR..':KARA_BOT:'..msg.chat_id_)
...
if not msg.Creator then return "✠*︙*هذا الامر يخص {المطور,المنشئ} فقط  \n✠" end
redis:setex(CZAR..'name:witting'..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "✠*︙*هذا الامر يخص {المطور,المنشئ} فقط  \n✠" end
redis:setex(CZAR..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(CZAR..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(CZAR..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(CZAR..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(CZAR..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20) FlterName(data.first_name_..' '..(data.last_name_ or ""),20) 
...
local KleshaID = '✠︙ أســمـك •⊱ { '..Namei..' } ⊰•\n'
..'✠︙ ايديــك •⊱ {'..msg.sender_user_id_..'} ⊰•\n'
..UserNameID
..'✠︙ رتبتـــك •⊱ '..msg.TheRank..' ⊰•\n'
..'✠︙ تفاعـلك •⊱ '..Get_Ttl(msgs)..'⊰•\n'
..'✠︙ رسائلك •⊱ {'..msgs..'} ⊰•\n✠'
local Kleshaidinfo = redis:get(CZAR..":infoiduser_public:"..msg.chat_id_) or redis:get(CZAR..":infoiduser")  
...
if redis:get(CZAR.."getidstatus"..msg.chat_id_) == "Photo" then
if data.photos_ and data.photos_[0] then 
sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,KleshaID,dl_cb,nil)
else
sendMsg(msg.chat_id_,msg.id_,'✠︙ لا يوجد صوره في بروفايلك ... !\n\n'..Flter_Markdown(KleshaID))
end
else
sendMsg(msg.chat_id_,msg.id_,Flter_Markdown(KleshaID))
end

end,{chat_id_=msg.sender_user_id_,id_=msg.id_,TheRank=arg.TheRank,sender_user_id_=data.id_,msgs=msgs,Namei=Namei,UserNameID=UserNameID,UserNameID1=UserNameID1})
...
redis:del(CZAR..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
...
local adduser = redis:get(CZAR..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "✠*︙*عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(CZAR..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
redis:del(CZAR..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(CZAR..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(CZAR..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(CZAR..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(CZAR..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(CZAR..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(CZAR..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(CZAR..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(CZAR..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(CZAR..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "✠*︙*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n✠" end
redis:set(CZAR..'welcom:witting'..msg.sender_user_id_,true) 
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⚜︙اهلا انآ بوت آسـمـي ]]..redis:get(CZAR..':NameBot:')..[[ ✓
...
if not msg.SudoUser then return "✠*︙*هذا الامر يخص {المطور} فقط  \n✠" end
return '✠*︙*عدد المشتركين في البوت : `'..redis:scard(CZAR..'users')..'` \n✠'
end
...
if not msg.SudoUser then return "✠*︙*هذا الامر يخص {المطور} فقط  \n✠" end
if redis:sismember(CZAR..'group:ids',MsgText[2]) then
local name_gp = redis:get(CZAR..'group:name'..MsgText[2])
...
return redis:get(CZAR..":TEXT_SUDO") or '🗃︙لا توجد كليشه المطور .\n??︙يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n✠'
end
...
if not msg.Admin then return "✠*︙*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n✠" end
redis:del(CZAR..'welcom:witting'..msg.sender_user_id_,
CZAR..'rulse:witting'..msg.sender_user_id_,
CZAR..'rulse:witting'..msg.sender_user_id_,
CZAR..'name:witting'..msg.sender_user_id_,
CZAR..'about:witting'..msg.sender_user_id_,
...
if not msg.SudoBase then return "✠*︙*هذا الامر يخص {المطور الاساسي} فقط  \n✠" end
local GetVerison = https.request('https://github.com/CZARTELLE/CZAR.github.io/GetVersion.txt') or 0
...
local inline = {{{text="⚜︙قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/@TH1CZAR"}}}
send_key(msg.sender_user_id_,'  [⚜︙قناة سورس : سيزر](t.me/@TH1CZAR)',nil,inline,msg.id_)
return false
end
...
CZAR..'replay_animation:group:'..msg.chat_id_,CZAR..'replay_audio:group:'..msg.chat_id_,CZAR..'replay_sticker:group:'..msg.chat_id_,CZAR..'replay_video:group:'..msg.chat_id_)
...
if names or photo or voice or imation or audio or sticker or video then
redis:del(CZAR..'replay:all',CZAR..'replay_photo:group:',CZAR..'replay_voice:group:',CZAR..'replay_animation:group:',CZAR..'replay_audio:group:',CZAR..'replay_sticker:group:',CZAR..'replay_video:group:')
...
if not msg.Admin then return "✠*︙*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n✠" end
if not redis:get(CZAR..'lave_me'..msg.chat_id_) then 
return "✠*︙*أهلا عزيزي "..msg.TheRankCmd.."\n✠*︙* المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(CZAR..'lave_me'..msg.chat_id_) 
return "✠*︙*أهلا عزيزي "..msg.TheRankCmd.."\n✠*︙* تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "✠*︙*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n✠" end
if redis:get(CZAR..'lave_me'..msg.chat_id_) then 
return "✠*︙*أهلا عزيزي "..msg.TheRankCmd.."\n✠*︙* المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(CZAR..'lave_me'..msg.chat_id_,true)  
...
return [[
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉     
👨🏼‍⚕️︙اهلا بك في سورس سيزر 
●ـ▬ـ▬ஜ۩۞۩ஜ▬ـ▬ـ●
✠︙[قناة السورس](t.me/TH1CZAR)
✠︙[قناة شروحات السورس](t.me/TH1CZAR)
✠︙[بوت تواصل](t.me/TH1CZAR)
✠︙[مطور السـورس](t.me/AA_B1)
●ـ▬ــ▬ஜ۩۞۩ஜ▬ـ▬ـ●
...
return '✠*︙*عدد سحہكآتگ ⇜ ❪ '..(redis:get(CZAR..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'سحكاتي'  then
local rfih = (redis:get(CZAR..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:setex(CZAR..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(CZAR..'CmD:'..msg.chat_id_,cmd)
redis:srem(CZAR..'CmDlist:'..msg.chat_id_,cmd)
...
if Text == "تفعيل الاجباري" and msg.SudoUser then
redis:set(CZAR..'joinchnl',true)
sendMsg(msg.chat_id_,msg.id_,'تم التفعيل')
end
if Text and redis:get(CZAR..'تغير الاجباري') and msg.SudoUser then
redis:set(CZAR..'setch',Text)
sendMsg(msg.chat_id_,msg.id_,'تم تعين القناه علي \n'..Text)
redis:del(CZAR..'setchs')
end
if Text and (Text:match("^تغير الاجباري$")) and msg.SudoUser then
sendMsg(msg.chat_id_,msg.id_,'ارسل معرفك بدون @')
redis:setex(CZAR..'setchs',120,true)
end
if Text == "تعطيل الاجباري" and msg.SudoUser then
redis:del(max..'joinchnl',true)
sendMsg(msg.chat_id_,msg.id_,'of')
end
...
function tophoto(kara,CZAR)   
if CZAR.content_.ID == "MessageSticker" then        
local bd = CZAR.content_.sticker_.sticker_.path_          
...
{"تعطيل الاجباري","تفعيل الاجباري"},
{"تغير الاجباري","الاشتراك الاجباري "},
...
text = [[✠︙آهلا انآ بــــوت آســمـي   []]..redis:get(CZAR..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(CZAR.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
local Bots = redis:get(CZAR.."lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
if not redis:get(CZAR..'Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusCreator" then
send(msg.chat_id_, msg.id_,'⚠︙ انت منشئ المجموعه ') 
return false
end
local Added_Me = redis:get(CZAR.."Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
...
if redis:get(CZAR..'Added:Me'..msg.chat_id_) then
sendMsg(msg.chat_id_,msg.id_,"✠*︙* أهلا عزيزي "..msg.TheRankCmd.."\n✠*︙* تم  تفعيل امر منو ضافني\n✓")
redis:del(CZAR..'Added:Me'..msg.chat_id_)  
else
...
if not redis:get(CZAR..'Added:Me'..msg.chat_id_) then
redis:set(CZAR..'Added:Me'..msg.chat_id_,true)  
sendMsg(msg.chat_id_,msg.id_,"✠*︙* أهلا عزيزي "..msg.TheRankCmd.."\n✠*︙* تم  تعطيل منو ضافني\n✓")
else
...
if redis:get(CZAR..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(CZAR..'welcom:witting'..msg.sender_user_id_) 
redis:set(CZAR..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"✠*︙* تم وضع الترحيب بنجاح كلاتي 👋\n✓" )
end
if redis:get(CZAR..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(CZAR..'rulse:witting'..msg.sender_user_id_) 
...
if redis:get(CZAR..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
...
redis:del(CZAR..'linkGroup'..msg.sender_user_id_,link) 
redis:set(CZAR..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'🖇︙تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(CZAR..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(CZAR..'about:witting'..msg.sender_user_id_) 
...
if msg.adduser and msg.adduser == our_id and redis:get(CZAR..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(CZAR..':WELCOME_BOT'),[[⚜︙اهلا انآ بوت آسـمـي ]]..redis:get(CZAR..':NameBot:')..[[ ✓
✠︙آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
✠︙مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...

مطور البوت ← ]]..SUDO_USER:gsub([[\_]],'_')..[[ 🌿
]])
return false
end 

if msg.forward_info and redis:get(CZAR..'fwd:'..msg.sender_user_id_) then
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(CZAR..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if not msg.forward_info and redis:get(CZAR..'lock_flood'..msg.chat_id_)  then
...
redis:setex(CZAR..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"✠︙العضو » "..USERNAME.."\n✠︙قمـت بتگرآر آگثر مـن "..NUM_MSG_CZAR.." رسـآلهہ‌‏ , لذآ تم تقييدگ مـن آلمـجمـوعهہ‌‏ ✓\n",12,USERCAR) 
return false
end)
end 
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(CZAR..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[A-Z]") or msg.text:match("[a-z]")) and redis:get(CZAR.."lock_enhso"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send lock_pharsi \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'✠*︙* لا يمكنني مسح الرساله المخالفه .\n🎟*︙* لست مشرف او ليس لدي صلاحيه  الحذف \n ❕')    
...
return false
elseif msg.edited and redis:get(CZAR..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(CZAR..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(CZAR..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(CZAR..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(CZAR..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(CZAR..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(CZAR..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(CZAR..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(CZAR..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
local creators = redis:smembers(CZAR..':MONSHA_BOT:'..GroupS)
if #creators ~= 0 then
